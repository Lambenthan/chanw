...
// Short-circuit if no webmention.io setup. Site doesn't currently use webmentions.
if (!TOKEN || !DOMAIN) {
  console.log(">>> Skipping webmention fetch: WEBMENTION_API_KEY / WEBMENTION_DOMAIN not set");
  process.exit(0);
}
